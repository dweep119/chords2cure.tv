		...
		<div class="container_topgap">	
			...
			<div class="container_credit">
				...
				<form id='frmStripePayment' name='frmStripePayment' action="" method="post">
					 ...
					 <div class="form-group">
						<label for="emailAddressCard"><span class='star'>*</span>E-mail</label>
						<div class="input-group">
							<div class="input-group-append">
								<span class="input-group-text"><i class="material-icons nav_icon">email</i></span>
							</div>
							<input type="text" class="form-control" id="emailAddressCard" name="emailAddressCard" placeholder="E-mail" value="<?php echo $_SESSION['USER_DETAILS']['USER_EMAIL']?>">
						</div>
					 ...
					 <div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-append">
								<span class="input-group-text" id="search_box"><i class="material-icons nav_icon">credit_card</i></span>
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="expire_date"><span class='star'>*</span>Expiry Month / Year</label>
								<div class="input-group">
								...
								<span class='form_error' id='span_month'></span>  
								<span class='form_error' id='span_year'></span>  
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="number" class="form-control" id="cvc" name="cvc" placeholder="Código de Segurança (CVV)" value="" maxlength="3">
								</div>
					...
					<div class="col-md-12">
						<div class="row">
							<button type="submit" class="btn btn btn-primary btn-inline-block btn_submit btnAction"  name="pay_now" id="submit-btn" onClick="stripePay(event);">Efetuar pagamento</button>
